adminControllers.controller('ServiceController', [ '$scope',
		...
		function($scope, $routeParams, $location, $http) {
			...
			$scope.editUserProfileDetails = function(){
				$http.get("api/v1/userProfile/"+userId, $scope.profile).success(function(res){
