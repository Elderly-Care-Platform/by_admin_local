adminControllers.controller('editIndividualCtrl', editIndividualCtrl)
editIndividualCtrl.$inject = ['$scope', '$rootScope', '$routeParams', '$location','$http'];
    function editIndividualCtrl($scope, $rootScope, $routeParams, $location, $http){
