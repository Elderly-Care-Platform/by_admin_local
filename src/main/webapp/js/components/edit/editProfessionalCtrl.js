adminControllers.controller('editProfessionalCtrl', editProfessionalCtrl)
editProfessionalCtrl.$inject = ['$scope', '$rootScope', '$routeParams', '$location','$http', 'UserProfile'];
    function editProfessionalCtrl($scope, $rootScope, $routeParams, $location, $http, UserProfile){
